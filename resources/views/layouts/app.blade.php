...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800&family=Open+Sans:ital,wght@0,400;0,600;1,400&family=Roboto:wght@300;400;500;700&display=swap" rel="stylesheet">
...
(function () {
    ...
    // If page has a dark hero, use light nav links until scrolled
    var hasDarkHero = document.querySelector('.page-hero') !== null;
    if (hasDarkHero) { nav.classList.add('dark-hero'); }
