  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-9" style="color:#444;line-height:1.85;font-size:1rem;">
        ...
        @if($links->isNotEmpty())
        <div style="background:#f8f9fb;border-radius:12px;padding:30px;margin-top:2rem;">
          <h4 style="color:#347595;font-family:Nunito,sans-serif;font-weight:700;">Useful Resources</h4>
        ...
        <a href="{{ route('home') }}#Contact" class="btn-send d-inline-block mt-4" style="text-decoration:none;">Open a Support Request</a>
      </div>
    </div>
  </div>
</section>
