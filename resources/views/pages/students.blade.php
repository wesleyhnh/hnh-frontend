@extends('layouts.app')
@section('title', 'Students – HereNOW Help')
@section('description', 'Student Wellness Platform. Helping students understand, track and improve their mental well-being.')
...
<section class="page-hero" style="background:linear-gradient(135deg,#4a8daa 0%,#87bcc6 50%,#3e97b5 100%),url('{{ asset('images/banner-1.jpg') }}') center/cover no-repeat fixed;min-height:55vh;display:flex;align-items:center;padding-top:90px;">
  <div class="container text-center">
    <h1 style="color:#fff;font-family:'Nunito',sans-serif;font-weight:800;font-size:2.8rem;">Student Wellness Platform</h1>
    <p style="color:rgba(255,255,255,.9);font-size:1.15rem;max-width:640px;margin:1rem auto;">Helping students understand, track and improve their mental well-being.</p>
...
<section style="background:#f8f9fb;padding:80px 0;">
  <div class="container text-center">
    <h2 style="color:#3e97b5;font-family:'Nunito',sans-serif;font-weight:800;font-size:2rem;margin-bottom:1rem;">K-12, Colleges and Universities</h2>
    <p style="color:#444;max-width:680px;margin:0 auto 2rem;">Learn to manage your own mental wellbeing while also connecting with peers and professionals before, during and after a crisis.</p>
